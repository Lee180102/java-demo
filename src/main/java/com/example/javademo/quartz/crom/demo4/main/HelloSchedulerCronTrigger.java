package com.example.javademo.quartz.crom.demo4.main;

import com.example.javademo.quartz.crom.demo4.job.HelloJobCronTrigger;
 ...
 * @author Lee
 */
public class HelloSchedulerCronTrigger {
    public static void main(String[] args) throws SchedulerException {
        ...
        // 任务实例 JobDetail
        JobDetail jobDetail = JobBuilder.newJob(HelloJobCronTrigger.class)// 加载任务类，与HelloJob完成绑定，要求HelloJob要实现Job接口；
...
//                .startNow()//现在开始
                .withSchedule(cronScheduleBuilder) //每五执行一次，秒执行三次
